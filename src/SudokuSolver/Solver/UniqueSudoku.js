 ...
 * }
 */
const _getIndexOfCell =(box, cell)=> {
 ...
 * @param {
 * tempInitArray: string array,
 * box: number,
 * value: number
 * }
 */
const _cellAvailable =(tempInitArray, box, value) =>{
 ...
 * @param {
 * solvedArray: string array,
 * difficulty: string,
 * e: change event nullable
 * }
 */
const _generateUniqueSudoku =(solvedArray, difficulty, e) =>{
